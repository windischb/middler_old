...
namespace middlerApp.API.Controllers.IdP.Consent
{
    ...
    public class ConsentController : Controller
    {
        ...
        public async Task<IActionResult> GetConsentViewModel(string returnUrl)
        {
        ...
        public async Task<IActionResult> PostConsentOptions([FromBody]ConsentInputModel model)
        {
