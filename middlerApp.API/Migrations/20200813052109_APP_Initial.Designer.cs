...
namespace middlerApp.API.Migrations
{
    ...
    [Migration("20200813052109_APP_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("middlerApp.API.DataAccess.EndpointActionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("middlerApp.API.DataAccess.EndpointRuleEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("middlerApp.API.DataAccess.TreeNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("middlerApp.API.DataAccess.EndpointActionEntity", b =>
                {
                    b.HasOne("middlerApp.API.DataAccess.EndpointRuleEntity", null)
                        .WithMany("Actions")
