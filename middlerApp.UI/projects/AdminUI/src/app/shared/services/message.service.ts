...
export class MessageService {
    ...
    constructor(private auth: OAuthService) {
        ...
        this.harrrConnection = HARRRConnection.create(
            builder => builder
                .withUrl("/signalr/ui", { accessTokenFactory: () => auth.getAccessToken()})
        ...
        this.harrrConnection.onServerRequest("Test", (arg1, arg2: number) => {


            console.log("Invoked from Server", arg1, arg2)
            
            return `${arg1[1] + arg1[1]} - ${window.location.toString()}`;
        })
